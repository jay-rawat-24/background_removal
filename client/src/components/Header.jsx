...
const Header = () => {
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        {/* left side */}
        <div>
            <h1 className='text-4xl sx:text-5xl 2xl:text-6xl font-bold text-neutral-700 leading-tight'>
            ...
            <p className='my-6 text-15px text-gray-500'>Apply dummy text of any image or <br className='max-sm:hidden'/> the generative AI images of your own choice</p>
            <div>
